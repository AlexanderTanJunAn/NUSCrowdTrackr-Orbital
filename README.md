...
We aim to develop a web application that allows users to be able to track the crowd level of selected areas like gym or canteens around NUS in real-time. This allow users to better plan their travel routes and timetable during peak periods.

## Features

We will be adapting most of our features from [https://gym-tracker.data.gov.sg/].

* Able to see the average occupancy of selected places over one-hour periods, shown in %
* Able to toggle between different days and timing for specific use
* Visualization of data for easy understanding
* Tracks past trend in average occupancy and display it

## Phase 1 (By 1 June)

* To have picked up on all the necessary technologies and developed basic understanding to starting working on the project.
* Have a  basic framework to work on
* Identified our application features

## Phase 2 (By 29 June) 

* Have the core features mentioned working
* Basic unit testing of each function
* Integrate frontend and backend

## Phase 3 (By 27 July)

* Extending current features, making improvements based on suggestions
* Full testing
* Improve UI/UX

## Working Video
https://www.youtube.com/watch?v=xt5KoCUVbiw

<a href="https://www.youtube.com/watch?v=xt5KoCUVbiw
" target="_blank"><img src="http://img.youtube.com/vi/xt5KoCUVbiw/0.jpg" 
